    ...
    <div className="home h-[92vh] w-full ">
      ...
      <Swiper pagination={true} modules={[Pagination]} className="mySwiper home">
        ...
        <div className="lg:basis-1/2 flex flex-col items-start">
            ...
            <h1 className='text-[2.05rem] lg:text-[3.2rem] poppins text-left leading-[2.8rem] lg:leading-[3.8rem] font-bold mt-2'>Streamline tracking and <span className='gradient-text2'>management</span> of company assets with our <span className='gradient-text1'>web app.</span></h1>
        ...
        <p className='mt-10 lg:mt-0 text-sm md:text-base px-3 md:px-6 rounded-2xl inline-block text-purple font-semibold bg-purple/10 text-left'>Effortless Asset Management for Your Business</p>
            <h1 className='text-[2.4rem] lg:text-[3.8rem] text-left leading-[2.5rem] lg:leading-[4.2rem] font-bold mt-2'>Track, <span className='text-purple'>manage</span>, and optimize your <span className='text-purple'>company</span> assets with ease.</h1>
