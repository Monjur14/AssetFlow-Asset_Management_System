        ...
        <div className="container p-2 mx-auto sm:p-4 dark:text-gray-800">
          <div className="overflow-x-auto">
              <div className="border-2 border-purple pr-1 px-2 py-1 rounded-md mb-5 flex justify-between items-center">
                ...
                <button className="px-5 py-1 gradient-bg2 font-semibold rounded-md text-white hidden md:block">Increase Your Members Limit</button>
              </div>
            <table className="min-w-full text-sm">
              ...
              <thead className="dark:bg-gray-300">
                <tr className="text-left">
                  ...
                  <th className="p-3 hidden md:block">Name</th>
